...
namespace Tomaso
{
    ...
    public class DesignStartConcreteFrameDesign: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public DesignStartConcreteFrameDesign()
          : base("Design > Concrete Frame Design > Start Design/Check", "DsgnCncrtFrmDsgnStrtDsgnChck",
            "ETABSv1.DesignConcrete.StartDesign()\nStarts the concrete frame design.",
            "Tomaso", "08_Design")
        {
        }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("515a0d9e-52da-46b4-9fd1-820d16c72f40");
    }
}