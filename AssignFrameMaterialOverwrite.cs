...
namespace Tomaso
{
    public class AssignFrameMaterialOverwrite: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignFrameMaterialOverwrite()
          : base("Assign > Frame > Material Overwrite", "AssgnFrmMtrlOvrwrt",
            "ETABSv1.SapModel.FrameObj.SetMaterialOverwrite()",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            In_Name = pManager.AddTextParameter("Name", "N", "The name of an existing frame object or group depending on the value of the ItemType item.", 
                GH_ParamAccess.list);
            In_PropName = pManager.AddTextParameter("PropName", "P", "",
                GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.FrameObj.SetMaterialOverwrite(Name[i], PropName[i], itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.AFrameMatOverwrite; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("e9444573-6fd2-4dde-9f38-eb5a679c50b2");
    }
}