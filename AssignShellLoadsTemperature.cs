...
namespace Tomaso
{
    public class AssignShellLoadsTemperature: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignShellLoadsTemperature()
          : base("Assign > Shell Loads > Temperature", "AssgnShllLdsTmprtr",
            "ETABSv1.SapModel.AreaObj.SetLoadTemperature()\nAssigns temperature loads to area objects. ",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.AreaObj.SetLoadTemperature(Name[i], LoadPat[i], MyType[i], Value[i], PatternName[i], Replace[i], itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.AShellLoadTemp; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("d27932a9-d7d7-4ac7-9b19-60218fcda3ce");
    }
}