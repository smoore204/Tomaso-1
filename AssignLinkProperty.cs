...
namespace Tomaso
{
    public class AssignLinkProperty: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignLinkProperty()
          : base("Assign > Link > Property", "AssgnLnkPrprty",
            "ETABSv1.SapModel.LinkObj.SetProperty()\nAssigns a link property to link objects.",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            In_Name = pManager.AddTextParameter("Name", "N", "The name of an existing frame object or group depending on the value of the ItemType item.", 
                GH_ParamAccess.list);
            In_PropName = pManager.AddTextParameter("PropName", "P", "This is the name of a link property to be assigned to the specified link object(s).",
                GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.LinkObj.SetProperty(Name[i], PropName[i], itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.ALinkProp; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("2fe58c2f-4da2-485e-9873-157cf3f20514");
    }
}