...
namespace Tomaso
{
    public class DefineFrameSectionsCircular: GH_Component
    {
        /// <summary>
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.PropFrame.SetCircle(Name[i], MatProp, T3[i]);
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("cb685066-7dcb-45b3-a13d-5ebda5e67add");
    }
}