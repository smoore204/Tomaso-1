...
namespace Tomaso
{
    public class AssignLinkLocalAxes: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignLinkLocalAxes()
          : base("Assign > Link > Local Axes", "AssgnLnkLclAxs",
            "ETABSv1.SapModel.LinkObj.SetLocalAxes()\nAssigns a local axis angle to link objects.",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            In_Name = pManager.AddTextParameter("Name", "N", "The name of an existing link object or group depending on the value of the ItemType item.", 
                GH_ParamAccess.list);
            In_Ang = pManager.AddNumberParameter("Ang", "A", "This is the angle that the local 2 and 3 axes are rotated about the positive local 1 axis, from the default orientation or, if the Advanced item is True, from the orientation determined by the plane reference vector. The rotation for a positive angle appears counter clockwise when the local +1 axis is pointing toward you. [deg]",
                GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (!DA.GetDataList(In_Ang, Ang)) { return; }
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.LinkObj.SetLocalAxes(Name[i], Ang[i], itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.ALinkLocal; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("1bb9bdc9-159b-4cd8-8b35-0f8ef1994502");
    }
}