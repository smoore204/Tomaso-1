...
namespace Tomaso
{
    public class DesignCompositeBeamSetGroup: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public DesignCompositeBeamSetGroup()
          : base("Design > Composite Beam Design > Select Design Group", "DsgnCmpsteBmDsgnGrp",
            "ETABSv1.SapModel.DesignCompositeBeam.SetGroup()\n",
            "Tomaso", "08_Design")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                for (int i = 0; i < Name.Count; i++) {
                    ret = mySapModel.DesignCompositeBeam.SetGroup(Name[i], Selected);
                }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("5fda24c5-a4f2-4b05-8384-dfd1f5014637");
    }
}