...
namespace Tomaso
{
    public class DefineDeckFilled: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public DefineDeckFilled()
          : base("Define > Deck > Filled", "DfnDckFlld",
            "ETABSv1.SapModel.PropArea.SetDeckFilled()\nInitializes a filled deck property.",
            "Tomaso", "04_Define")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            In_Name = pManager.AddTextParameter("Name", "N", "The name of an existing deck property created with the Define Shell Deck function. ", 
                GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.PropArea.SetDeckFilled(Name[i], SlabDepth[i], RibDepth[i], RibWidthTop[i], RibWidthBot[i], RibSpacing[i], ShearThickness[i], UnitWeight[i], ShearStudDia[i], ShearStudHt[i], ShearStudFu[i]);
                }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("a39a513e-3127-4355-85f0-866feb65a29a");
    }
}