...
namespace Tomaso
{
    ...
    public class DesignStartSteelFrameDesign: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public DesignStartSteelFrameDesign()
          : base("Design > Steel Frame Design > Start Design/Check", "DsgnStlFrmDsgnStrtDsnChck",
            "ETABSv1.DesignSteel.StartDesign()\nStarts the steel frame design.",
            "Tomaso", "08_Design")
        {
        }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("134ab0ba-8e5b-458a-9e32-38c89eba08f8");
    }
}