...
namespace Tomaso
{
    public class AssignShellLocalAxes: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignShellLocalAxes()
          : base("Assign > Shell > Local Axes", "AssgnShllLclAxs",
            "ETABSv1.SapModel.AreaObj.SetLocalAxes()\nAssigns a local axis angle to area objects.",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.AreaObj.SetLocalAxes(Name[i], Ang[i], itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.AShellLocal; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("3a4ca8f9-07b3-4da9-b3d5-ced1a7c7ee71");
    }
}