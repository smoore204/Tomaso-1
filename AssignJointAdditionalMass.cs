...
namespace Tomaso
{
    public class AssignJointAdditionalMass: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignJointAdditionalMass()
          : base("Assign > Joint > Additional Mass", "AssgnJntAddtnlMss",
            "ETABSv1.SapModel.PointObj.SetMass()",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            In_Name = pManager.AddTextParameter("Name", "N", "The name of an existing point object or group depending on the value of the ItemType item.", 
                GH_ParamAccess.list);
            In_M = pManager.AddNumberParameter("Mass", "M", "This is a list of six values: \nValue(1) = UX/UY \nValue(2) = UX/UY \nValue(3) = UZ \nValue(4) = RX \nValue(5) = RY \nValue(6) = RZ",
                GH_ParamAccess.list);
            In_Replace = pManager.AddBooleanParameter("Replace", "R", "If this item is True, all previous, if any, assigned to the specified point object(s) are deleted before making the new assignment.",
                GH_ParamAccess.item, false);
            In_IsLocalCSys = pManager.AddBooleanParameter("CSys", "C", "The name of the coordinate system for the considered additional mass. This is Local or the name of a defined coordinate system.",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (!DA.GetDataList(In_M, M)) { return; }
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.PointObj.SetMass(Name[i], ref m, itemType, IsLocalCSys, Replace);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.AJointMass; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("a403910c-34ca-41bd-ad8f-b1a735dd23c7");
    }
}