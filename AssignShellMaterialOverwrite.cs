...
namespace Tomaso
{
    public class AssignShellMaterialOverwrite: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignShellMaterialOverwrite()
          : base("Assign > Shell > Material Overwrite", "AssgnShllMtrlOvrwrt",
            "ETABSv1.SapModel.AreaObj.SetMaterialOverwrite()",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.AreaObj.SetMaterialOverwrite(Name[i], PropName[i], itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.AShelMatOverwrite; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("7e28eb6f-6006-4fd7-83f8-d63bdc9d35e1");
    }
}