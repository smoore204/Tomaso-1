...
namespace Tomaso
{
    ...
    public class DesignStartCompositeBeamDesign: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public DesignStartCompositeBeamDesign()
          : base("Design > Composite Beam Design > Start Design/Check", "DsgnCmpstBmDsgnStrtDsgnChck",
            "ETABSv1.DesignCompositeBeam.StartDesign()\nStarts the composite beam design.",
            "Tomaso", "08_Design")
        {
        }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("84569d12-6a2d-41f7-9300-4ae4034129b8");
    }
}