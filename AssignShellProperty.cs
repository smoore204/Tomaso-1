...
namespace Tomaso
{
    public class AssignShellProperty: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignShellProperty()
          : base("Assign > Shell > Property", "AssgnShllPrpty",
            "ETABSv1.SapModel.AreaObj.SetProperty()\nAssigns an area property to area objects.",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            In_Name = pManager.AddTextParameter("Name", "N", "The name of an existing area object or group depending on the value of the ItemType item.", 
                GH_ParamAccess.list);
            In_PropName = pManager.AddTextParameter("PropName", "P", "This is None or the name of a area property to be assigned to the specified area object(s). None means that no property is assigned to the area object.",
                GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.AreaObj.SetProperty(Name[i], PropName[i], itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.AShellProp; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("ef581422-bfdc-4ffc-b09b-fb20a61bbad1");
    }
}