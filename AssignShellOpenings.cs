...
namespace Tomaso
{
    public class AssignShellOpenings: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignShellOpenings()
          : base("Assign > Shell > Openings", "AssgnShllOpnngs",
            "ETABSv1.SapModel.AreaObj.SetSOpening()\nDesignates an area object(s) as an opening.",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            In_Name = pManager.AddTextParameter("Name", "N", "The name of an existing object or group depending on the value of the ItemType item.", 
                GH_ParamAccess.list);
            In_IsOpening = pManager.AddBooleanParameter("IsOpening", "O", "This item should be set to True if the specified area object(s) is to be an opening, otherwise it should be False.",
            ...
            pManager[In_IsOpening].Optional = true;
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                if (IsOpening.Count == 1)
                {
                    for (int i = 0; i < Name.Count - 1; i++)
                    {
                        IsOpening.Add(IsOpening[0]);
                    }
                }
                ...
                {
                    ret = mySapModel.AreaObj.SetOpening(Name[i], IsOpening[i], itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.AssgnShllOpnngs; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("e7a1c033-b960-401b-9f1d-4d9a4af5ea0e");
    }
}