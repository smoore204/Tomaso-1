...
namespace Tomaso
{
    public class AssignFramePierLabel: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignFramePierLabel()
          : base("Assign > Frame > Pier Label", "AssgnFrmPrLbl",
            "ETABSv1.SapModel.FrameObj.SetPier()\nSets the pier label assignment of one or more frame objects ",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            In_Name = pManager.AddTextParameter("Name", "N", "The name of an existing frame object or group depending on the value of the ItemType item.", 
                GH_ParamAccess.list);
            In_PierName = pManager.AddTextParameter("PierName", "P", "The name of the pier assignment, or 'None', to unset any assignment",
                GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<string> PierName = new List<string>();
            int ItemType = 0;

            if (!DA.GetData(In_Run, ref Run)){return;}
            if (!DA.GetDataList(In_Name, Name)){ return; }
            if (!DA.GetDataList(In_PierName, PierName)) { return; }
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.FrameObj.SetPier(Name[i], PierName[i], itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.AFramePier; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("73f42509-43bc-4297-9f89-f4eb6a089689");
    }
}