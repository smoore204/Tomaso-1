...
namespace Tomaso
{
    public class AssignFramePropertyModifiers: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignFramePropertyModifiers()
          : base("Assign > Frame > Property Modifiers", "AssgnFrmPrprtyMdfrs",
            "ETABSv1.SapModel.FrameObj.SetModifiers()\nSets the frame modifier assignment for frame objects. The default value for all modifiers is one.",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            In_Name = pManager.AddTextParameter("Name", "N", "The name of an existing frame object or group depending on the value of the ItemType item.", 
                GH_ParamAccess.list);
            In_Value = pManager.AddNumberParameter("Value", "V", "This is a list of eight unitless modifiers: \n1. Cross sectional area modifier\n2. Shear area in local 2 direction modifier\n3. Shear area in local 3 direction modifier\n4. Torsional constant modifier\n5. Moment of inertia about local 2 axis modifier\n6. Moment of inertia about local 3 axis modifier\n7. Mass modifier\n8. Weight modifier",
                GH_ParamAccess.list, new List<double> { 1, 1, 1, 1, 1, 1, 1, 1 });
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.FrameObj.SetModifiers(Name[i], ref value, itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.AFramePropMod; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("f7256014-bd18-453a-a0ac-28d016ce8720");
    }
}