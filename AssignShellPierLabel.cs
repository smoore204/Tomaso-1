...
namespace Tomaso
{
    public class AssignShellPierLabel: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignShellPierLabel()
          : base("Assign > Shell > Pier Label", "AssgnShllPrLbl",
            "ETABSv1.SapModel.AreaObj.SetPier()\nSets the pier label assignment of one or more area objects ",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.AreaObj.SetPier(Name[i], PierName[i], itemType);
                }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("c1d3d905-95fc-4c56-a832-720fa15f03f4");
    }
}