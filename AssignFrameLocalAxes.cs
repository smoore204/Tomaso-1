...
namespace Tomaso
{
    public class AssignFrameLocalAxes: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignFrameLocalAxes()
          : base("Assign > Frame > Local Axes", "AssgnFrmLclAxs",
            "ETABSv1.SapModel.FrameObj.SetLocalAxes()\nAssigns a local axis angle to frame objects.",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            In_Name = pManager.AddTextParameter("Name", "N", "The name of an existing frame object or group depending on the value of the ItemType item.", 
                GH_ParamAccess.list);
            In_Ang = pManager.AddNumberParameter("Ang", "A", "This is the angle that the local 2 and 3 axes are rotated about the positive local 1 axis, from the default orientation. The rotation for a positive angle appears counter clockwise when the local +1 axis is pointing toward you. [deg]",
                GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.FrameObj.SetLocalAxes(Name[i], Ang[i], itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.AFrameLocal; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("2d473521-7f3b-46d8-8ed8-1e81eedda217");
    }
}