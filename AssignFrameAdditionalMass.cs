...
namespace Tomaso
{
    public class AssignFrameAdditionalMass: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignFrameAdditionalMass()
          : base("Assign > Frame > Additional Mass", "AssgnFrmAddtnlMss",
            "ETABSv1.SapModel.FrameObj.SetMass()",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            In_Name = pManager.AddTextParameter("Name", "N", "The name of an existing frame object or group depending on the value of the ItemType item.", 
                GH_ParamAccess.list);
            In_Mass = pManager.AddNumberParameter("Mass", "M", "Mass over length",
                GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.FrameObj.SetMass(Name[i], Mass[i], Replace[i], itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.AFrameMass; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("816760a7-20e0-4f28-a1b9-70d004f93867");
    }
}