...
namespace Tomaso
{
    public class AssignJointLoadsForce: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignJointLoadsForce()
          : base("Assign > Joint Loads > Force", "AssgnJntLdsFrc",
            "ETABSv1.SapModel.PointObj.SetLoadForce()\nMakes point force load assignments to point objects.",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.PointObj.SetLoadForce(Name[i], LoadPat, ref value, Replace, CSys, itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.AJointLoadForce; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("2d749289-dd79-42d7-a79d-0ff7c5946c66");
    }
}