...
namespace Tomaso
{
    public class DefinePierLabel: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public DefinePierLabel()
          : base("Define > Pier Labels", "DfnPrLbls",
            "ETABSv1.SapModel.PierLabel.SetPier()\nAdds a new Pier Label ",
            "Tomaso", "04_Define")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.PierLabel.SetPier(Name[i]);
                }
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.DPier; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("4a1fec6f-dd80-4022-ad27-9d8f4d98c4aa");
    }
}