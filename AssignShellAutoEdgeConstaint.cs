...
namespace Tomaso
{
    public class AssignShellAutoEdgeConstaint: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignShellAutoEdgeConstaint()
          : base("Assign > Shell > Auto Edge Constraint", "AssgnShllAtEdgCnstrnt",
            "ETABSv1.SapModel.AreaObj.SetEdgeConstraint()\nMakes generated edge constraint assignments to area objects.",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            In_Name = pManager.AddTextParameter("Name", "N", "The name of an existing area object or group depending on the value of the ItemType item.", 
                GH_ParamAccess.list);
            In_ConstraintExists = pManager.AddBooleanParameter("ConstraintExists", "C", "This item is True if an automatic edge constraint is generated by the program for the area object in the analysis model.",
                GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<bool> ConstraintExists = new List<bool>();
            int ItemType = 0;

            if (!DA.GetData(In_Run, ref Run)){return;}
            if (!DA.GetDataList(In_Name, Name)){ return; }
            if (!DA.GetDataList(In_ConstraintExists, ConstraintExists)) { return; }
            ...
            if (Run)
            {
                ...
                if (ConstraintExists.Count == 1)
                {
                    for (int i = 0; i < Name.Count - 1; i++)
                    {
                        ConstraintExists.Add(ConstraintExists[0]);
                    }
                }
                ...
                {
                    ret = mySapModel.AreaObj.SetEdgeConstraint(Name[i], ConstraintExists[i], itemType);
        ...
        protected override System.Drawing.Bitmap Icon { get { return Tomaso.Properties.Resources.AShellAutoEdge; } }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("096ed8e6-9a39-47a6-aac9-eeeed501b7c1");
    }
}