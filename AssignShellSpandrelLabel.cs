...
namespace Tomaso
{
    public class AssignShellSpandrelLabel: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AssignShellSpandrelLabel()
          : base("Assign > Shell > Spandrel Label", "AssgnShllSpndrlLbl",
            "ETABSv1.SapModel.AreaObj.SetSpandrel()\nSets the Spandrel label assignment of one or more area objects ",
            "Tomaso", "06_Assign")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                {
                    ret = mySapModel.AreaObj.SetSpandrel(Name[i], SpandrelName[i], itemType);
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("4e225416-e9aa-4cab-aa1e-d834968ed800");
    }
}