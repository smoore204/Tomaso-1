...
namespace Tomaso
{
    public class DesignGetSteelFrameDesignSection: GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public DesignGetSteelFrameDesignSection()
          : base("Design > Steel Frame Design > Get Design Section", "DsnStlFrmDsgnGtDsgnSctn",
            "ETABSv1.SapModel.DesignSteel.GetDesignSection()\nRetrieves the design section for a specified steel frame object ",
            "Tomaso", "08_Design")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Run)
            {
                ...
                for (int i = 0; i < Name.Count; i++) {
                    ret = mySapModel.DesignSteel.GetDesignSection(Name[i], ref PropName);
                }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("b4c08413-e6f2-434f-9df5-850c37265fe7");
    }
} 